...
echo_html(
    ...
    .'<script type="text/javascript" src="js/BubbleShape/Bomb/Blue.js"></script>'
    .'<script type="text/javascript" src="js/BubbleShape/Bomb/Canvas.js"></script>'
    .'<script type="text/javascript" src="js/BubbleShape/Bomb/Green.js"></script>'
    .'<script type="text/javascript" src="js/BubbleShape/Bomb/Red.js"></script>'
    .'<script type="text/javascript" src="js/BubbleShape/Bomb/Violet.js"></script>'
    .'<script type="text/javascript" src="js/BubbleShape/Bomb/White.js"></script>'
    .'<script type="text/javascript" src="js/BubbleShape/Bomb/Yellow.js"></script>'
    .'<script type="text/javascript" src="js/BubbleShape/Injection/Blue.js"></script>'
    .'<script type="text/javascript" src="js/BubbleShape/Injection/Canvas.js"></script>'
    .'<script type="text/javascript" src="js/BubbleShape/Injection/Green.js"></script>'
    .'<script type="text/javascript" src="js/BubbleShape/Injection/Red.js"></script>'
    .'<script type="text/javascript" src="js/BubbleShape/Injection/Violet.js"></script>'
    .'<script type="text/javascript" src="js/BubbleShape/Injection/White.js"></script>'
    .'<script type="text/javascript" src="js/BubbleShape/Injection/Yellow.js"></script>'

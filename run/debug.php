...
echo_html(
    ...
    .'<script type="text/javascript" src="js/BubbleShape/GreenInjection.js"></script>'
    ...
    .'<script type="text/javascript" src="js/BubbleShape/RedInjection.js"></script>'
    ...
    .'<script type="text/javascript" src="js/BubbleShape/VioletInjection.js"></script>'
    ...
    .'<script type="text/javascript" src="js/BubbleShape/WhiteInjection.js"></script>'
    ...
    .'<script type="text/javascript" src="js/BubbleShape/YellowInjection.js"></script>'
